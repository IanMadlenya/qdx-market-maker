...
public final class BcDecryptor {
    ...
    public Cleartext decrypt(String message)
        ...
        try {
            ...
            if (signature.verify(signatureList.get(0))) {
                ...
                String decrypted = new String(out.toByteArray(), StandardCharsets.UTF_8);

                return new Cleartext(decrypted, publicKey.getFingerprint());
            }
