...
public class MarketMakerConfiguration {
    ...
    public MarketMakerConfiguration(
            ...
            double fairVolatility,
            double volatilitySpreadFraction,
            double sabrBeta,
            double sabrVolOfVol,
            double sabrRho,
            boolean sabrUseTimeAdjustedVolOfVol,
            int numLevels,
            int qtyOnLevel,
            double deltaLimit,
            double vegaLimit
        ...
        checkArgument(fairPriceSensitivityFraction.compareTo(BigDecimal.ZERO) > 0,
